...
import { ChevronDown, ArrowRight, Shield, Users } from "lucide-react";
            ...
            <div className="space-y-10">
                ...
                <div className="flex flex-col sm:flex-row gap-6">
                  <div className="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3 shadow-md">
                    ...
                    <div>
                      ...
                      FastAPI REST API serving <code>/predict</code> endpoint
                      and model artifacts.
                    </div>
                  </div>
                  <div className="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3 shadow-md">
                  ...
                  <div className="flex items-center gap-3 bg-white/5 rounded-xl px-4 py-3 shadow-md">
                    ...
                    <div>
                      ...
                      Logistic Regression for good vs. bad credit
                      classification.
                    </div>
                  </div>
                </div>
              ...
              <div className="pt-8">
                ...
                <ul className="list-disc pl-6 space-y-2 text-lg">
                  ...
                  <li>
                    Scalable, production-ready artifact loading and serving
                  </li>
                  {/* <li>
              ...
              <div className="pt-8">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                  ...
                  <span className="inline-flex items-center gap-1 bg-white/10 rounded px-3 py-1 text-base font-semibold">
                    <Image src="/window.svg" alt="npm" width={20} height={20} />{" "}
                    npm
                  </span>
                </div>
              </div>
